...
const Header = () => {
    ...
    const { handleLogOut, userLoading } = useFirebase();
    ...
    return (
        <Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="p-3">
            {
                userLoading ? <Spinner animation="grow" /> : <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <HashLink className="me-3 nav-link text-dark fst-italic fw-bold" style={{ fontWeight: '' }} to="/about">About</HashLink>

                            <HashLink className="me-3 nav-link text-dark fst-italic fw-bold" style={{ fontWeight: '' }} to="/team">Team</HashLink>

                            <HashLink className="me-3 nav-link text-dark fst-italic fw-bold" style={{ fontWeight: '' }} to="/contact">Contact Us</HashLink>
